function Strings(config) {
    ...
    const values = {
        ...
        en: {
            ...
            'menubar/add/Panel':'Panel',
            'menubar/add/Steel Door':'Steel Door',
            'menubar/add/Cover L/R':'Cover',
            'menubar/add/Glass Door':'Glass Door',
            "menubar/add/Adjecnt Door":'Adjcent Door',
            "menubar/add/Splitter":'Splitter',
            "menubar/add/Louver Cover":'Louver Cover',
            "menubar/add/Cable Gland":'Cable Gland',
            "menubar/add/Mounting Plate":'Mounting Plate',
            "menubar/add/Din Module":'Din Module',
            "menubar/add/Bus Bar Holder":'Bus Bar Holder',
            "menubar/add/Bus Bar":'Bus Bar',

            'toolbar/Panel':'Panel',
            'toolbar/Steel Door':'Steel Door',
            'toolbar/Cover':'Cover',
            'toolbar/Glass Door':'Glass Door',
            "toolbar/Adjecnt Door":'Adjcent Door',
            "toolbar/Splitter":'Splitter',
            "toolbar/Louver Cover":'Louver Cover',
            "toolbar/Cable Gland":'Cable Gland',
            "toolbar/Mounting Plate":'Mounting Plate',
            "toolbar/Din Module":'Din Module',
            "toolbar/Bus Bar Holder":'Bus Bar Holder',
            "toolbar/Bus Bar":'Bus Bar',
