...
import {
    TGALoader
} from './loaders/TGALoader.js';

import {
    AddObjectCommand
} from './commands/AddObjectCommand.js';
import {
    SetSceneCommand
} from './commands/SetSceneCommand.js';
            ...
            case '3dm':

                {
                    ...
                    reader.addEventListener('load', async function(event) {
                        ...
                        import ('three/addons/loaders/3DMLoader.js');
            ...
            case '3ds':

                {
                    ...
                    reader.addEventListener('load', async function(event) {
                        ...
                        import ('three/addons/loaders/TDSLoader.js');
            ...
            case 'amf':

                {
                    ...
                    reader.addEventListener('load', async function(event) {
                        ...
                        import ('three/addons/loaders/AMFLoader.js');
            ...
            case 'ifc':

                {
                    ...
                    reader.addEventListener('load', async function(event) {
                        ...
                        import ('three/addons/loaders/IFCLoader.js');
            ...
            case 'kmz':

                {
                    ...
                    reader.addEventListener('load', async function(event) {
                        ...
                        import ('three/addons/loaders/KMZLoader.js');
            ...
            case 'md2':

                {
                    ...
                    reader.addEventListener('load', async function(event) {
                        ...
                        import ('three/addons/loaders/MD2Loader.js');
            ...
            case 'pcd':

                {
                    ...
                    reader.addEventListener('load', async function(event) {
                        ...
                        import ('../../examples/jsm/loaders/PCDLoader.js');
            ...
            case 'usdz':

                {
                    ...
                    reader.addEventListener('load', async function(event) {
                        ...
                        import ('../../examples/jsm/loaders/USDZLoader.js');
            ...
            case 'vox':

                {
                    ...
                    reader.addEventListener('load', async function(event) {
                        ...
                        import ('three/addons/loaders/VOXLoader.js');
            ...
            case 'wrl':

                {
                    ...
                    reader.addEventListener('load', async function(event) {
                        ...
                        import ('three/addons/loaders/VRMLLoader.js');
            ...
            case 'xyz':

                {
                    ...
                    reader.addEventListener('load', async function(event) {
                        ...
                        import ('three/addons/loaders/XYZLoader.js');
