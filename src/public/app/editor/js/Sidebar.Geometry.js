...
} from './commands/SetGeometryValueCommand.js';

import {
    SidebarGeometryBufferGeometry
} from './Sidebar.Geometry.BufferGeometry.js';
import {
    SidebarGeometryModifiers
} from './Sidebar.Geometry.Modifiers.js';

import {
    VertexNormalsHelper
} from './examples/jsm/helpers/VertexNormalsHelper.js';
        ...
        if (object && object.geometry) {
            ...
            if (currentGeometryType !== geometry.type) {
                ...
                if (geometry.type === 'BufferGeometry') {
                    ...
                    import (`./Sidebar.Geometry.${ geometry.type }.js`);
            ...
            if (object.children.length > 0) {
                console.log("Object has children:", object.children);
            }
