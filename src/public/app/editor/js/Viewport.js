...
import {
    TransformControls
} from './examples/jsm/controls/TransformControls.js';
...
import {
    ViewportInfo
} from './Viewport.Info.js';

import {
    ViewHelper
} from './Viewport.ViewHelper.js';
import {
    VR
} from './Viewport.VR.js';
...
import {
    RoomEnvironment
} from './examples/jsm/environments/RoomEnvironment.js';
...
function Viewport(editor) {
    ...
    const grid1 = new THREE.GridHelper(5000, 100, 0xf00000, 0x545353);
    grid1.material.color.setHex(0x888888);
    grid1.material.vertexColors = false;
    grid.add(grid1);

    const grid2 = new THREE.GridHelper(300, 20, 0x222222);
