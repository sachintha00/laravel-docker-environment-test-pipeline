var colors = ["#3073F1", "#0acf97"],
    ...
    options = {
        ...
        series: [
            ...
            { name: "Working Hours", data: [176, 185, 256, 240, 187, 205, 191, 114, 194] },
        ],
        xaxis: { categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct"] },
        legend: { offsetY: 7 },
        fill: { opacity: 1 },
        grid: { row: { colors: ["transparent", "transparent"], opacity: 0.2 }, borderColor: "#9ca3af20", padding: { bottom: 5 } },
    },
    ...
    options = {
        ...
        colors: (colors = (dataColors = document.querySelector("#monthly-target").dataset.colors) ? dataColors.split(",") : colors),
        responsive: [{ breakpoint: 480, options: { chart: { width: 200 }, legend: { position: "bottom" } } }],
    },
    colors = ((chart = new ApexCharts(document.querySelector("#monthly-target"), options)).render(), ["#3073F1", "#0acf97", "#fa5c7c", "#ffbc00"]),
    options = {
        chart: { height: 350, type: "radialBar" },
        colors: (colors = (dataColors = document.querySelector("#project-overview-chart").dataset.colors) ? dataColors.split(",") : colors),
        series: [85, 70, 80, 65],
