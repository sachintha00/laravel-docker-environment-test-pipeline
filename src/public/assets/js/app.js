class App {
    initComponents() {
        ...
        window.addEventListener("scroll", function () {
            72 < window.pageYOffset ? (e.classList.add("flex"), e.classList.remove("hidden")) : (e.classList.remove("flex"), e.classList.add("hidden"));
        }),
...
class ThemeCustomizer {
        ...
        document.querySelectorAll("ul.menu a.menu-link").forEach((t) => {
            ...
            setTimeout(function () {
                ...
                function r() {
                    ...
                    var e,
                        t,
                        n = (e /= o / 2) < 1 ? (n / 2) * e * e + t : (-n / 2) * (--e * (e - 2) - 1) + t;
                    (i.scrollTop = n), d < o && setTimeout(r, 20);
                }
                null != t && ((e = document.querySelector(".app-menu .simplebar-content-wrapper")), (t = t.offsetTop - 300), e && 100 < t && ((o = 600), (c = (i = e).scrollTop), (a = t - c), (d = 0), r()));
            }, 200);
    }
    reverseQuery(e, t) {
        for (; e; ) {
    ...
    changeThemeDirection(e) {
        (this.config.direction = e), this.html.setAttribute("dir", e), this.setSwitchFromConfig();
    }
    changeThemeMode(e) {
        (this.config.theme = e), this.html.setAttribute("data-mode", e), this.setSwitchFromConfig();
    }
    changeLayoutWidth(e, t = !0) {
        this.html.setAttribute("data-layout-width", e), t && ((this.config.layout.width = e), this.setSwitchFromConfig());
    }
    changeLayoutPosition(e, t = !0) {
        this.html.setAttribute("data-layout-position", e), t && ((this.config.layout.position = e), this.setSwitchFromConfig());
    }
    changeTopbarColor(e) {
    ...
    changeSidenavView(e, t = !0) {
        this.html.setAttribute("data-sidenav-view", e), t && ((this.config.sidenav.view = e), this.setSwitchFromConfig());
    }
    resetTheme() {
    ...
    initSwitchListener() {
        var n = this,
            e =
                (document.querySelectorAll("input[name=dir]").forEach(function (t) {
                    t.addEventListener("change", function (e) {
                        n.changeThemeDirection(t.value);
                    });
                }),
                document.querySelectorAll("input[name=data-mode]").forEach(function (t) {
                    t.addEventListener("change", function (e) {
                ...
                document.querySelectorAll("input[name=data-sidenav-view]").forEach(function (t) {
                    t.addEventListener("change", function (e) {
            ...
            e =
                (e &&
                    e.addEventListener("click", function () {
                        ...
                        "mobile" === t
                            ? (n.showBackdrop(), n.html.classList.toggle("sidenav-enable"))
                            : "hidden" == e
                            ? "hidden" === t
                                ? n.changeSidenavView("hidden" == e ? "default" : e, !1)
            ...
            e =
                (e &&
                    e.addEventListener("click", function () {
                        ...
                        "hover" == e
                            ? "hover" === t
                                ? n.changeSidenavView("hover" == e ? "hover-active" : e, !0)
                                : n.changeSidenavView("hover", !0)
                            : "hover-active" === t
                            ? n.changeSidenavView("hover-active" == e ? "hover" : e, !0)
    ...
    showBackdrop() {
        const e = document.createElement("div"),
            t =
                ((e.id = "backdrop"),
                (e.classList = "transition-all fixed inset-0 z-40 bg-gray-900 bg-opacity-50 dark:bg-opacity-80"),
                document.body.appendChild(e),
                document.getElementsByTagName("html")[0] && ((document.body.style.overflow = "hidden"), 1140 < window.innerWidth && (document.body.style.paddingRight = "15px")),
                this);
        e.addEventListener("click", function (e) {
    ...
    adjustLayout() {
        window.innerWidth <= 1140 ? this.changeSidenavView("mobile", !1) : this.changeSidenavView(this.config.sidenav.view);
    }
    setSwitchFromConfig() {
        sessionStorage.setItem("__CONFIG__", JSON.stringify(this.config)),
            document.querySelectorAll("#theme-customization input[type=radio]").forEach(function (e) {
                e.checked = !1;
            });
        var e,
            t,
            ...
            a = this.config;
        a &&
            ((e = document.querySelector("input[type=radio][name=dir][value=" + a.direction + "]")),
            (t = document.querySelector("input[type=radio][name=data-mode][value=" + a.theme + "]")),
            (n = document.querySelector("input[type=radio][name=data-layout-width][value=" + a.layout.width + "]")),
            (i = document.querySelector("input[type=radio][name=data-layout-position][value=" + a.layout.position + "]")),
            (o = document.querySelector("input[type=radio][name=data-topbar-color][value=" + a.topbar.color + "]")),
            (c = document.querySelector("input[type=radio][name=data-menu-color][value=" + a.menu.color + "]")),
            (a = document.querySelector("input[type=radio][name=data-sidenav-view][value=" + a.sidenav.view + "]")),
            e && (e.checked = !0),
            t && (t.checked = !0),
            n && (n.checked = !0),
            i && (i.checked = !0),
    ...
    init() {
        this.initConfig(), this.initSidenav(), this.initSwitchListener(), this.initWindowSize(), this.adjustLayout(), this.setSwitchFromConfig();
    }
}
