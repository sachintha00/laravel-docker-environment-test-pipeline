...
<head>
    <meta charset="utf-8">
    <title>Recover Password | Konrix - Responsive Tailwind Admin Dashboard</title>
            ...
            <div class="2xl:w-1/4 lg:w-1/3 md:w-1/2 w-full">
                <div class="card overflow-hidden sm:rounded-md rounded-none">
                    <div class="p-6">
                        ...
                        <p class="text-gray-500 dark:text-gray-400 text-center">Back to<a href="auth-login.html" class="text-primary ms-1"><b>Log In</b></a></p>
                    </div>
                </div>
            </div>
        </div>
